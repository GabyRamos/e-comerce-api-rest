                ...
                <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                            ...
                            <li>
                                <a href="{{ url('language_switch/es') }}" class="btn btn-link"> EspaÃ±ol</a>
                            </li>
                            <li>
                                <a href="{{ url('language_switch/ar') }}" class="btn btn-link"> Ø¹Ø±Ø¨Ù‰</a>
                            </li>
                            <li>
                                <a href="{{ url('language_switch/pt_BR') }}" class="btn btn-link"> Portuguese</a>
                            </li>
                            <li>
                                <a href="{{ url('language_switch/fr') }}" class="btn btn-link"> FranÃ§ais</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="{{ url('language_switch/hi') }}" class="btn btn-link"> à¤¹à¤¿à¤‚à¤¦à¥€</a>
                            </li>
                            <li>
                                <a href="{{ url('language_switch/vi') }}" class="btn btn-link"> Tiáº¿ng Viá»‡t</a>
                            </li>
                            <li>
                                <a href="{{ url('language_switch/ru') }}" class="btn btn-link"> Ñ€ÑƒÑÑÐºÐ¸Ð¹</a>
                            </li>
                            <li>
                                <a href="{{ url('language_switch/tr') }}" class="btn btn-link"> TÃ¼rk</a>
                            </li>
                            <li>
