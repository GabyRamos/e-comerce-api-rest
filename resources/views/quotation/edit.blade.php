                                ...
                                <div class="row">
                                	<div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required id="customer_id" name="customer_id" class="selectpicker form-control" data-live-search="true" id="customer-id" data-live-search-style="begins" title="Seleccionar cliente...">
